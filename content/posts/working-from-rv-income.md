...
faqs:
  - q: "How much should I have saved before going full-time?"
    a: "Six months of your full projected expenses minimum, not counting your rig purchase. If your monthly budget is $4,500, that's $27,000 liquid before you leave. This isn't paranoid; it's the cushion that lets you survive a slow client month or a surprise repair without making panicked decisions."
  - q: "Can I really get reliable enough internet to work remotely from an RV?"
    a: "Yes, but you have to invest in the setup and be honest about your route. A dual-carrier cellular setup with a quality router like the Pepwave MAX BR1 Pro or Netgear M6 handles most office-type work reliably. You won't have perfect coverage everywhere, but you can plan around the gaps."
  - q: "Is it legal to work remotely while traveling between states?"
    a: "For freelancers and self-employed people, generally yes, with some tax complexity. For W2 employees, it depends heavily on your employer's HR policies and your employment contract. Some states trigger tax obligations after 15-30 days of presence; others use different thresholds. Talk to a CPA who works with nomads before assuming it's fine."
  - q: "What's the easiest income stream to start while still at home?"
...
What I mean is: the specific *how* matters less than building a system that can flex. A friend of mine, Jess, left her HR job in 2021 with a solid $4,200/month freelance writing contract. By month six, that client had cut the budget and she was back to $1,800. She kept her rig because she had two smaller clients she'd been cultivating on the side. That's not a lucky story; that's the model.

Don't think "I need a remote job." Think "I need income streams that don't depend on a single point of failure." It sounds like business school talk, but I mean it practically: you want at least two, ideally three, sources with different payers and different risk profiles.
...
The IRS and individual state tax authorities are genuinely complicated here. I'm not a tax professional, and you should talk to one who specializes in nomadic or multi-state situations before you assume your employer is cool with full-timing. The folks at Keystone CPA or Greenback Tax Services handle location-independent earners specifically and are worth the $300-400 consultation fee.

Freelance and contract work, by contrast, puts you in control of where your clients think you are (usually nowhere in particular, since you're likely using a mail forwarding address anyway). You own the relationship. The volatility is real, but so is the flexibility.

The categories I've personally seen work consistently for full-timers:

- **Software development and QA testing.** The gold standard. A solid mid-level developer can clear $8,000-12,000/month on Toptal or direct contracts, and no client cares where you're parked.
...
- **Online course creation and digital products.** Front-loaded work, but passive once it's built. Teachable and Gumroad both work fine on a campground wifi connection.
- **Virtual bookkeeping.** Underrated. Steady monthly retainers, not much glamour, genuinely hard to automate, and $40-75/hour is realistic once you have a small client base. Bookkeeper Launch is the training program I've heard good things about from people who went through it.
...
I'll say this plainly: if you don't have a marketable skill yet, learn one before you hit the road. The "I'll figure it out on the road" crowd has a high attrition rate. I've watched too many people sell their rigs and move back home within eighteen months because they couldn't stabilize income.
...
My honest floor for comfortable full-timing with a modest safety net is $5,000/month net, assuming no rig payment. With a rig payment, add whatever that is. With a family, obviously adjust up. I've met people doing it on $2,800/month and making it work, but they're boondocking almost exclusively and deferring maintenance, which is a slow disaster in progress.

---

## Building Income Before You Leave

If I were advising someone starting from scratch today, here's the sequence I'd actually recommend.
...
The first six months on the road, don't try to grow your income. Just protect what you have. New surroundings, new routines, constant logistical decisions -- it takes genuine mental bandwidth. I worked 20% less efficiently my first three months on the road than I did in my apartment. I wasn't prepared for that.
