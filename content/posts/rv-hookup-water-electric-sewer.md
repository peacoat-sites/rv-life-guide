...
faqs:
  - q: "Do I need to use a surge protector at every campground, even nice ones?"
    a: "Yes. I've blown past this question a lot of times in conversation and I'll say it clearly: the campground's reputation has nothing to do with the condition of their electrical pedestals. A broken ground wire or a reverse-polarity connection is invisible to you without testing equipment. A surge protector or EMS device tests the connection before allowing power in. Use it every single time."
  - q: "Can I leave my sewer hose connected the whole time I'm at a site?"
    a: "You can, but don't leave the valves open. Keep the hose connected for convenience, keep the valves closed until you're actively dumping. The one exception some people make is the gray tank on a long stay, but even then, leaving it open means the P-trap in the connection can dry out and you'll get sewer gas smell in the rig."
  - q: "My water pressure feels low even with city water hookup. What's happening?"
    a: "A few possibilities: your pressure regulator may be set too conservatively (some cheap preset regulators drop to 40 PSI or lower), the campground pressure is genuinely low, or there's a partially closed valve somewhere in your system. Check that your onboard pump is off (it can interfere with city water pressure on some rigs), and if you have an adjustable regulator, try dialing it up slightly."
  - q: "How often should I dump my black tank?"
...
Getting your hookups right isn't complicated once you understand the logic behind the sequence. But "not complicated" doesn't mean "obvious." There's a reason experienced RVers develop a setup ritual they never deviate from.

---

## The Right Order Actually Matters

Most campground guides won't tell you this directly, but the sequence in which you connect your utilities matters for both safety and cleanliness. Here's the order I use after eight years, and why.

**Level first. Always.** Before anything connects to anything, get the rig level. If you're on water when you decide to nudge the rig two feet forward on leveling blocks, you're either yanking a hose or leaving connections half-on. Level the coach, set your stabilizers, and *then* move on to hookups.
...
**Sewer last.** Always, always last. This one isn't debatable.

---

## Electric Hookup: 30-Amp vs. 50-Amp and What Goes Wrong

If you're new to this, the amp service question is the first thing that trips people up. Most older or smaller rigs run on 30-amp service. Larger fifth wheels, Class A coaches, and anything with two air conditioners typically need 50-amp. A 50-amp RV can plug into a 30-amp pedestal with an adapter, but you'll be managing your power usage carefully. A 30-amp rig on 50-amp service with a dogbone adapter works fine.

The pedestal connection itself is straightforward: make sure the breaker on the pedestal is off before you plug in. This is especially true on 50-amp hookups because those connectors are large and you want to avoid any arcing on connection. Plug in, then flip the pedestal breaker. When you disconnect, reverse it: breaker off first, then unplug.

What most people don't realize is that campground power quality varies wildly. State parks tend to be better maintained than some private campgrounds built out in the 1970s and never seriously upgraded. I've seen voltage readings as low as 103 volts at a busy Florida campground in July, when everyone's running their AC. That low voltage is actually more damaging to your appliances over time than a spike. A good surge protector with an EMS (Electrical Management System) will monitor voltage and cut power if it drops into dangerous territory.

One more thing: extension cords. Don't use them. If your cord doesn't reach the pedestal, you need a longer 30-amp or 50-amp shore power cord, not a home extension cord run in series. The amperage you're pulling will overheat a household extension cord.

---

## Water Hookup: Pressure, Filtration, and the Freeze Warning
...
## Sewer Hookup: The Part Nobody Loves But Everyone Needs to Understand

The sewer connection is where new full-timers make the mistakes that give them stories they'll tell for years. I'll save you the story.

**Step-by-step sewer hookup:**
...
The biggest rookie mistake: leaving the black tank valve open continuously. People do this thinking it's easier. What actually happens is the liquids drain away immediately, the solids stay behind, and you end up with what full-timers call "the pyramid of shame." Keep the black tank closed until it's at least two-thirds full, then dump. Keep enough water in the black tank during use so things can move.

Gray tank management is more flexible, but I still leave it closed most of the time and dump it after the black tank. Running gray water through the line after a black tank dump helps rinse the sewer hose.

When you disconnect: close both valves, remove the hose from the cleanout first, then disconnect from the RV. Cap both ends of the hose, rinse it out with the campground hose or a dedicated flush hose, store it in a sealed compartment.
...
| Electric only (W/E) | Water and electric, no sewer | Tank dumps at dump station |
| Electric only | Power, no water/sewer | Water from tank, dump station |
| Dry camping / boondocking | Nothing from the campground | Everything: water, power, waste |
...
### Do I need to use a surge protector at every campground, even nice ones?

Yes. I've blown past this question a lot of times in conversation and I'll say it clearly: the campground's reputation has nothing to do with the condition of their electrical pedestals. A broken ground wire or a reverse-polarity connection is invisible to you without testing equipment. A surge protector or EMS device tests the connection before allowing power in. Use it every single time.

### Can I leave my sewer hose connected the whole time I'm at a site?

You can, but don't leave the valves open. Keep the hose connected for convenience, keep the valves closed until you're actively dumping. The one exception some people make is the gray tank on a long stay, but even then, leaving it open means the P-trap in the connection can dry out and you'll get sewer gas smell in the rig.

### My water pressure feels low even with city water hookup. What's happening?

A few possibilities: your pressure regulator may be set too conservatively (some cheap preset regulators drop to 40 PSI or lower), the campground pressure is genuinely low, or there's a partially closed valve somewhere in your system. Check that your onboard pump is off (it can interfere with city water pressure on some rigs), and if you have an adjustable regulator, try dialing it up slightly.

### How often should I dump my black tank?

At minimum, when it reaches two-thirds to three-quarters full. If you're on full hookups and staying more than a week, that's typically every three to five days for two people. Always do a tank flush after dumping if your rig has a built-in flush system. If it doesn't, a [tank rinser wand](https://www.amazon.com/s?k=rv+black+tank+rinser+wand&tag=rvlife-20) that goes in through the toilet works reasonably well. *(This site may earn a commission on qualifying purchases.)*

### Is it okay to drink the water from the campground hookup?

Technically the water is generally potable, but "potable" is a low bar. Quality varies by location, the hose and fittings sitting outside all season aren't helping anything, and some campgrounds are on municipal water systems while others run wells. I run a filter on all incoming water and use a separate gravity filter for drinking and cooking water. It's a small inconvenience that eliminates a category of problems.

---

The full-hookup routine becomes genuinely automatic after a few months. You stop thinking about the order and just do it. But getting to that point means building the habit correctly from the start, with the right gear and the right sequence. Get those pieces in place and you'll spend a lot less time troubleshooting and a lot more time actually enjoying wherever you've landed. That's the whole point of this life.
