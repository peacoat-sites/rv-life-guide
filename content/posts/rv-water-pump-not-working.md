---
title: "RV Water Pump Not Working: Fix It Fast Today"
...
slug: "rv-water-pump-not-working"
affiliate_disclosure: false
faqs:
  - q: "Why does my RV water pump run but no water comes out?"
    a: "The most common causes are a low or empty fresh water tank, a clogged inlet strainer on the pump, or a suction-side air leak preventing the pump from priming. Check your tank level first, then clean the inlet strainer before assuming the pump is failed."
  - q: "How do I know if my RV water pump is bad or if it's something else?"
    a: "Use a multimeter to confirm you have 12V at the pump terminals with the switch on. If voltage is present and the pump still won't run or run properly, the pump itself is likely at fault. If there's no voltage, the problem is upstream in the circuit."
  - q: "Why does my RV water pump keep running and won't shut off?"
    a: "A pump that won't cycle off almost always means it can't build enough pressure to trigger the internal shut-off switch. Look for a leak anywhere downstream, including dripping faucets, a running toilet flapper, or loose fittings behind cabinet walls."
  - q: "How long should an RV water pump last?"
...
- [Shurflo Product and Service Documentation](https://www.shurflo.com): Manufacturer specs and service guides for 2088 series pumps, including pressure settings and diaphragm service intervals.
- [RV Industry Association (RVIA) Technical Resources](https://www.rvia.org): Industry standards for RV plumbing systems, 12V circuit ratings, and water system specifications.
- [iRV2 Community Forums](https://www.irv2.com): Aggregated owner-reported repair experiences; useful for real-world failure rates and common brand-specific issues.
- [Practical Sailor / Independent Marine & RV Equipment Reviews](https://www.practical-sailor.com): Independent testing of marine and RV water pumps, including pressure consistency and lifespan comparisons.

---


*Photo: [Magic K](https://www.pexels.com/@magic-k-24827758) via Pexels*