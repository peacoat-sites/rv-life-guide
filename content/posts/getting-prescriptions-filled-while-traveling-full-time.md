...
slug: "getting-prescriptions-filled-while-traveling-full-time"
affiliate_disclosure: false
faqs:
 - q: "Can I fill a prescription in any state if I use a national chain pharmacy?"
   a: "For non-controlled medications, yes, usually. Your prescription can be transferred between locations of the same chain. For Schedule II-IV controlled substances, state laws and federal regulations add significant friction, and some pharmacists will decline out-of-state or out-of-chain transfers entirely."
 - q: "What's the easiest way to get prescriptions filled without a local doctor?"
   a: "Telehealth is the practical answer for most medications. Platforms like Teladoc can connect you with a provider licensed in your current state, who can then send a prescription to a local or mail-order pharmacy. It's not free (expect $75-$150 for an urgent visit), but it's faster and cheaper than an urgent care for routine medication needs."
 - q: "Can my doctor call in a prescription to any pharmacy in the country?"
   a: "For non-controlled drugs, yes, your doctor can send an electronic prescription to essentially any pharmacy. For controlled substances, your doctor must be licensed to prescribe in the state where you're physically located, and even then, the prescription must comply with that state's rules."
 - q: "How do full-timers handle 90-day supplies when insurance only allows monthly fills?"
...
**Scenario 1:** Full-timer on Metformin, insurance through ACA marketplace plan, no mail-order set up.
Action: Enrolled in mail-order pharmacy, set up Escapees address in Texas as mailing address, switched to 90-day fills.
Result: Prescription cost dropped from $28/month to $19 per 90-day supply, zero pharmacy-hunting required.

**Scenario 2:** Full-timer with ADHD on Adderall (Schedule II), tried to transfer prescription across state lines.
Action: Established care with a psychiatrist via a telehealth platform operating in their current state (Florida), got a new in-state prescription sent to a local pharmacy.
Result: Filled within 24 hours, though the psychiatrist required a 30-minute intake visit ($95 out of pocket, not covered).
...
**Scenario 3:** Reader (Diane from Michigan, she emailed me after a piece I wrote on RV healthcare) was managing thyroid medication and a blood thinner while full-timing.
Action: Set up mail order for both, established telehealth relationship with a GP licensed in her domicile state (Florida), kept 45-day buffer on hand at all times.
Result: Zero prescription disruptions over 14 months of travel across 22 states.

---

## Sources

- [DEA Controlled Substance Schedules](https://www.dea.gov/drug-information/drug-scheduling): Official federal scheduling list, essential reference for understanding which prescriptions have transfer restrictions.
- [National Alliance of State Pharmacy Associations (NASPA)](https://naspa.us): State-by-state pharmacy law summaries, particularly useful for controlled substance transfer rules.
- [Teladoc Health Provider Network](https://www.teladochealth.com): Current (July 2026) state-by-state availability and prescribing guidelines for telehealth.
- [Cost Plus Drugs (Mark Cuban Cost Plus Drug Company)](https://costplusdrugs.com): Transparent cash pricing on generics; a legitimate alternative to insurance-based filling.
- [Escapees RV Club Mail Forwarding](https://www.escapees.com): Most widely used mail forwarding service among full-timers; essential infrastructure for mail-order pharmacy setup.
