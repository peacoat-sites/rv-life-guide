...
faqs:
  - q: "Can I mix lithium and AGM batteries in the same bank?"
    a: "No. Don't do it. They have different charging profiles, different voltage curves, and different internal resistance. Mixing them means one battery type will be consistently over or undercharged, shortening the life of both. If you're switching to lithium, switch the whole bank at once."
  - q: "Will my existing 7-pin trailer connector charge my lithium batteries while driving?"
    a: "The 7-pin connector typically passes through limited amperage (often just enough to maintain a charge, not meaningfully charge depleted batteries). A DC-to-DC charger, also called a B2B charger, between your tow vehicle's alternator and your lithium bank is the proper solution. Victron and Renogy both make solid options in the $150-$300 range."
  - q: "How do I know if my solar charge controller is lithium-compatible?"
    a: "Check the spec sheet for a lithium or LiFePO4 charging profile option. Most MPPT controllers made after 2017 or so have it. The setting is usually adjustable via a button on the unit or through an app. If yours doesn't have a lithium setting, you'll need to upgrade it, because charging with the wrong profile consistently undercharges lithium batteries."
  - q: "What happens if I accidentally let lithium batteries drain to 0%?"
...
**Cold temperature cutoff.** Lithium batteries cannot be charged below about 32°F (0°C) without causing permanent damage. Good batteries have a low-temperature charging cutoff built into the BMS. Some premium batteries, like those from Lithionics, have integrated heating elements for winter use. If you camp in cold climates, this is not optional.

**Brand reputation and warranty.** Battle Born, Renogy, Ampere Time, and AIMS Power are all brands I've seen real full-timers use long-term with good results. Look for at least a 5-year warranty. Ten-year warranties exist and are worth paying for.
...
One thing I want to flag: make sure you budget for the full system upgrade, not just the batteries. If you're switching to lithium, your converter/charger may need to be replaced with a lithium-compatible unit. Older converters have charging profiles designed for lead-acid and can actually undercharge or damage lithium batteries over time. A decent lithium-compatible converter like the Progressive Dynamics 4600 series runs $150 to $250. Factor that in.
...
No. Don't do it. They have different charging profiles, different voltage curves, and different internal resistance. Mixing them means one battery type will be consistently over or undercharged, shortening the life of both. If you're switching to lithium, switch the whole bank at once.

### Will my existing 7-pin trailer connector charge my lithium batteries while driving?

The 7-pin connector typically passes through limited amperage (often just enough to maintain a charge, not meaningfully charge depleted batteries). A DC-to-DC charger, also called a B2B charger, between your tow vehicle's alternator and your lithium bank is the proper solution. Victron and Renogy both make solid options in the $150-$300 range.

### How do I know if my solar charge controller is lithium-compatible?

Check the spec sheet for a lithium or LiFePO4 charging profile option. Most MPPT controllers made after 2017 or so have it. The setting is usually adjustable via a button on the unit or through an app. If yours doesn't have a lithium setting, you'll need to upgrade it, because charging with the wrong profile consistently undercharges lithium batteries.

### What happens if I accidentally let lithium batteries drain to 0%?

A good BMS will disconnect the battery before it reaches true zero, usually cutting off around 10-11.5V. If the BMS trips into low-voltage cutoff, you won't damage the battery. Just apply a charge and it will reset. If you somehow bypassed the BMS and deeply discharged a lithium cell, recovery is sometimes possible but not guaranteed. This is why BMS quality matters.

### Is a lithium battery upgrade worth it for a weekend warrior who only goes out once or twice a month?

Honestly, it depends on how you camp. If you're always at full-hookup sites, AGM works fine and lithium is probably overkill. If you dry camp even occasionally, or if you want solar to be genuinely useful, lithium makes that experience dramatically better. For full-timers and frequent boondockers, it's one of the best investments you can make. For someone camping 15 days a year at campgrounds, maybe spend that money on a good water filter instead.
