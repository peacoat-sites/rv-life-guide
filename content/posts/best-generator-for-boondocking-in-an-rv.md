...
What most people don't realize is that a 2,200-watt inverter generator will NOT reliably start a residential-style rooftop AC unit on its own. It'll usually handle RV-specific AC units (like a Dometic Penguin II or a Coleman-Mach) if you add a soft-starter like the [Micro-Air EasyStart 364](https://www.amazon.com/dp/B07CWJFHYY?tag=rvlife-20), which drops startup amp draw from around 65A to roughly 15A. That $300 soft-starter is the difference between a generator that works and one that trips the breaker every time you flip on the AC.
